...
// REMOVED: saveLegacyNote server action
// All legacy note creation now goes through /api/vault/save-legacy-note
// This ensures consistent limit enforcement and prevents bypassing API checks
