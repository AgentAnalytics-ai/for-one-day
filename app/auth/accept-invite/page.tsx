...
/**
 * Household invitation landing — existing users accept here; new users sent to signup.
 */
export default async function AcceptInvitePage({
  ...
  if (!user) {
    redirect(`/auth/signup?token=${encodedToken}`)
  }

  const result = await acceptHouseholdInvitation(token.trim())
