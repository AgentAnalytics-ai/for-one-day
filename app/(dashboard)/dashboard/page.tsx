...
export default async function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div 
        className="relative min-h-[700px] rounded-3xl overflow-hidden"
        style={{
          backgroundImage: 'linear-gradient(rgba(0,0,0,0.35), rgba(0,0,0,0.45)), url(/father-daughter-sunset-beach.png)',
          backgroundSize: 'cover',
          backgroundPosition: 'center'
        }}
      >
        
        <div className="relative z-10 text-center max-w-3xl mx-auto pt-20 pb-12 md:pt-24 md:pb-16 px-6 md:px-8">
